...
public class ContentBean {
	...
	private String content_reply_text;
	
	public String getContent_reply_text() {
		return content_reply_text;
	}

	public void setContent_reply_text(String content_reply_text) {
		this.content_reply_text = content_reply_text;
	}
